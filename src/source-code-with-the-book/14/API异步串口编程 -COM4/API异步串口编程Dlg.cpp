...
// API异步串口编程Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "API异步串口编程.h"
#include "API异步串口编程Dlg.h"
...
BOOL CAPIDlg::OnInitDialog()
{
	...
	//获取文件句柄
	handleFile = CreateFile("COM4",GENERIC_READ | GENERIC_WRITE,0,0,
		OPEN_EXISTING,FILE_FLAG_OVERLAPPED,0);	//重叠方式
	...
	timeous.ReadIntervalTimeout = 2000;		//读取间隔超时设置为2秒
