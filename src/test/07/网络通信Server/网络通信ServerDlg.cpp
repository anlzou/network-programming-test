...
// 网络通信ServerDlg.cpp : implementation file
//

#include "stdafx.h"
#include "网络通信Server.h"
#include "网络通信ServerDlg.h"
...
// 	char pIp[4] = htent->h_addr_list[0];
// 	IN_ADDR addrIp;
// 	memmove(&addrIp,pIp,4);
...
void CServerDlg::OnSendbtn() 
{
	// TODO: Add your control notification handler code here
	UpdateData(true);
	if(SOCKET_ERROR == send(socket_client,m_send.GetBuffer(1),
		m_send.GetLength(),NULL) )
	{
		MessageBox("消息发送出错");
		return;
	}
